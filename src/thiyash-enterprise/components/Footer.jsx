...
const Footer = () => {
  ...
  const handleProductClick = (e, categoryKey) => {
    ...
    // Else, allow standard navigation to /enterprise/products with state
  };
        ...
        <footer className="footer">
          <div className="footer-grid">
            ...
            <Reveal className="fg-col" animation="reveal-up" delay="0.2s">
              <h4>Products</h4>
              <ul>
                <li><Link to="/enterprise/products" state={{ activeCat: 'chemicals' }} onClick={(e) => handleProductClick(e, 'chemicals')}>Cleaning Chemicals</Link></li>
                <li><Link to="/enterprise/products" state={{ activeCat: 'tools' }} onClick={(e) => handleProductClick(e, 'tools')}>Cleaning Tools</Link></li>
                <li><Link to="/enterprise/products" state={{ activeCat: 'hygiene' }} onClick={(e) => handleProductClick(e, 'hygiene')}>Hygiene & Sanitization</Link></li>
                <li><Link to="/enterprise/products" state={{ activeCat: 'laundry' }} onClick={(e) => handleProductClick(e, 'laundry')}>Laundry Care</Link></li>
              </ul>
            </Reveal>
            <Reveal className="fg-col" animation="reveal-right" delay="0.3s">
              ...
              <div className="foot-ci">
                ...
                <p>88/11, Thendral Nagar, Chenniyavalasu Road, Perundurai – 638 052</p>
              </div>
              <div className="foot-ci">
                <svg viewBox="0 0 24 24">
                  <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.8 19.79 19.79 0 01.01 1.22 2 2 0 012 0h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 14.92z" />
          ...
          <div className="footer-bottom">
            <div className="footer-bottom-left">
              <p className="copyright-text">© 2026 Thiyash Enterprise. All rights reserved. | Proprietor: K. Ragavendran B.E.</p>
