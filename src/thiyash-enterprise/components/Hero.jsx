    ...
    <section id="hero" ref={heroRef}>
      ...
      <div className="hero-inner">
        <Reveal className="hero-col-left" animation="reveal-up">
          ...
          <h1 className="hero-title-line visible" style={{ marginTop: '-15px', transitionDelay: '0.2s' }}><span style={{color: '#E5E7EB'}}>for</span> <em style={{ color: '#1A5FA8' }}>Housekeeping & Cleaning</em></h1>
